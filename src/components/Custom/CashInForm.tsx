...
import { cashIn } from "@/serverActions/paymentAction";
import { toast } from "sonner";

const CashInForm = ({ user }: { user: any }) => {
      // Form state
      ...
      const handleCashIn = async (e: React.FormEvent) => {
            ...
            if (Object.keys(formErrors).length === 0) {
                  const payload = { reciverId: receiverId, amount: Number(amount), ref, pin, senderId: user?.userId, payType: "Cash In" };
            ...
            <Card className="max-w-md w-full mt-10">
                  <CardHeader>
                        ...
                        <CardDescription className="text-center">
                              Cash in possibale only personal account
                        </CardDescription>
                  </CardHeader>
                  ...
                  <CardContent>
                        <div className="grid w-full items-center gap-4">
                              <div className="flex flex-col space-y-1.5">
                                    <Label htmlFor="number">Pesonal Number / Email</Label>
                                    <Input
                                          value={receiverId}
                  ...
                  <CardFooter className="flex justify-end">
                        <Dialog>
                              ...
                              <DialogContent className="sm:max-w-[425px]">
                                    ...
                                    <DialogFooter>
                                          {/* Submit button */}
                                          <Button onClick={handleCashIn}>Confirm Payment</Button>
                                    </DialogFooter>
                              </DialogContent>
                        </Dialog>
                  </CardFooter>
